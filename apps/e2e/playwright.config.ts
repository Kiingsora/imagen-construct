...
const workspaceDirectory = path.join(repositoryRoot, ".e2e-workspace");
...
export default defineConfig({
  ...
  webServer: [
    {
      command: "uv run uvicorn imagen_construct.main:app --host 127.0.0.1 --port 8000",
      ...
      env: {
        ...process.env,
        IMAGEN_CONSTRUCT_WORKSPACE: workspaceDirectory,
      },
    },
    {
